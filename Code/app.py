...
tpot_data = pd.read_csv('https://raw.githubusercontent.com/karthikreddykuna/BootcampSession/master/Code/prepared_data.csv')
...
# User defined values
title = 'App'
encoder_location = 'https://github.com/karthikreddykuna/BootcampSession/blob/master/Code/encoder.pkl?raw=true'
